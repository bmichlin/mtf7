...
const mtf7::word_64bit *mtf7::emutf_amc13_trailer_block_operator::unpack( const word_64bit *at_ptr ){
  ...
  _unpacked_event_info -> _amc13_trailer_evt_lgth = (_16bit_word_a & 0xff) << 16;
  _unpacked_event_info -> _amc13_trailer_evt_lgth |= _16bit_word_b & 0xffff;
  _unpacked_event_info -> _amc13_trailer_crc16 = _16bit_word_c & 0xffff;
  _16bit_word_d >>= 2;
  _unpacked_event_info -> _amc13_trailer_r = _16bit_word_d & 0x1; _16bit_word_d >>= 1;
  _unpacked_event_info -> _amc13_trailer_t = _16bit_word_d & 0x1; _16bit_word_d >>= 1;
  _unpacked_event_info -> _amc13_trailer_tts = _16bit_word_d & 0xf; _16bit_word_d >>= 4;
  _unpacked_event_info -> _amc13_trailer_evt_stat = _16bit_word_d & 0xf; _16bit_word_d >>= 6;
  _unpacked_event_info -> _amc13_trailer_f = _16bit_word_d & 0x1; _16bit_word_d >>= 1;
  _unpacked_event_info -> _amc13_trailer_c = _16bit_word_d & 0x1;
...
unsigned long mtf7::emutf_amc13_trailer_block_operator::pack(){
  ...
  _16bit_word_a = (_event_info_to_pack -> _amc13_trailer_evt_lgth >> 16) & 0xff;
  _16bit_word_a |= 0xa000;

  _16bit_word_b = _event_info_to_pack -> _amc13_trailer_evt_lgth & 0xffff;
  ...
  _16bit_word_d |= _event_info_to_pack -> _amc13_trailer_r & 0x1; _16bit_word_d <<= 2;
