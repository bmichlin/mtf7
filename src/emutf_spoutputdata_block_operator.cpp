...
unsigned long mtf7::emutf_spoutputdata_block_operator::pack(){
  ...
  _16bit_word_a = _event_info_to_pack -> _track_hl & 0x1; _16bit_word_a <<= 1;
  _16bit_word_a |= _event_info_to_pack -> _track_c & 0x1; _16bit_word_a <<= 1;
  _16bit_word_a |= _event_info_to_pack -> _track_vc & 0x1; _16bit_word_a <<= 12;
  _16bit_word_a |= _event_info_to_pack -> _track_phi_inner & 0xfff;
  _16bit_word_a |= 0x8000;

  _16bit_word_b = _event_info_to_pack -> _track_se & 0x1; _16bit_word_b <<= 1;
  _16bit_word_b |= _event_info_to_pack -> _track_bc0 & 0x1; _16bit_word_b <<= 12;
  _16bit_word_b |= _event_info_to_pack -> _track_phi_outer & 0xfff; 

  _16bit_word_c = _event_info_to_pack -> _track_quality & 0xf; _16bit_word_c <<= 9;
  _16bit_word_c |= _event_info_to_pack -> _track_quality & 0x1ff; 
  _16bit_word_c |= 0x8000;

  _16bit_word_d = _event_info_to_pack -> _track_bx & 0x7; _16bit_word_d <<= 9;
  _16bit_word_d |= _event_info_to_pack -> _track_pt & 0x1ff; 

  *ptr = merge_abcd_words(); ptr++;

  // pack 2nd 64 bit word

  _16bit_word_a = _event_info_to_pack -> _track_me4_id & 0x3; _16bit_word_a <<= 2;
  _16bit_word_a |= _event_info_to_pack -> _track_me3_id & 0x3; _16bit_word_a <<= 2;
  _16bit_word_a |= _event_info_to_pack -> _track_me2_id & 0x3; _16bit_word_a <<= 3;
  _16bit_word_a |= _event_info_to_pack -> _track_me1_id & 0x3;

  _16bit_word_b = _event_info_to_pack -> _track_tbin_num & 0x7; _16bit_word_b <<= 3;
  _16bit_word_b |= _event_info_to_pack -> _track_me4_tbin & 0x7; _16bit_word_b <<= 3;
  _16bit_word_b |= _event_info_to_pack -> _track_me3_tbin & 0x7; _16bit_word_b <<= 3;
  _16bit_word_b |= _event_info_to_pack -> _track_me2_tbin & 0x7; _16bit_word_b <<= 3;
  _16bit_word_b |= _event_info_to_pack -> _track_me1_tbin & 0x7; _16bit_word_b <<= 3;
  _16bit_word_b |= 0x8000;

  _16bit_word_c = _event_info_to_pack -> _track_pt_lut_address & 0x7fff;
  _16bit_word_c |= 0x8000;

  _16bit_word_d = (_event_info_to_pack -> _track_pt_lut_address >> 15) & 0x7fff;
