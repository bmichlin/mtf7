...
const mtf7::word_64bit *mtf7::emutf_trailer_block_operator::unpack( const word_64bit *at_ptr ){
  ...
  _unpacked_event_info -> _trailer_l1a  =  _16bit_word_a & 0xff; _16bit_word_a >>= 8;
  _unpacked_event_info -> _trailer_ddcrs_lf = _16bit_word_a & 0xf;
  _16bit_word_b >>= 7;
  _unpacked_event_info -> _trailer_lfff = _16bit_word_b & 0x1; _16bit_word_b >>= 1;
  _unpacked_event_info -> _trailer_ddcrs_lf |= (_16bit_word_b & 0xf) << 4;
  _unpacked_event_info -> _trailer_mm = _16bit_word_c & 0xf; _16bit_word_c >>= 4;
  _unpacked_event_info -> _trailer_yy = _16bit_word_c & 0xf; _16bit_word_c >>= 4;
  _unpacked_event_info -> _trailer_bb = _16bit_word_c & 0x1;
  _unpacked_event_info -> _trailer_spcrs_scc = _16bit_word_d & 0xfff;
...
unsigned long mtf7::emutf_trailer_block_operator::pack(){
  ...
  _16bit_word_a = _event_info_to_pack -> _trailer_ddcrs_lf & 0xf; _16bit_word_a <<= 8;
  _16bit_word_a |= _event_info_to_pack -> _trailer_l1a & 0xff;
  _16bit_word_a |= 0xf000;

  _16bit_word_b = _event_info_to_pack -> _trailer_ddcrs_lf & 0xf0; _16bit_word_b <<= 1;
  _16bit_word_b |= _event_info_to_pack -> _trailer_lfff & 0x1; _16bit_word_b <<= 7;
  _16bit_word_b |= 0x7f;
  _16bit_word_b |= 0xf000;

  _16bit_word_c = _event_info_to_pack -> _trailer_bb & 0x1; _16bit_word_c <<= 4;
  _16bit_word_c |= _event_info_to_pack -> _trailer_yy & 0xf; _16bit_word_c <<= 4;
  _16bit_word_c |= _event_info_to_pack -> _trailer_mm & 0xf;
  _16bit_word_c |= 0xf000;

  _16bit_word_d = _event_info_to_pack -> _trailer_spcrs_scc & 0x7ff;
  ...
  *ptr = merge_abcd_words(); ptr++;
  ...
  _16bit_word_a = _event_info_to_pack -> _trailer_dd & 0x1f;
  ...
  _16bit_word_c = _event_info_to_pack -> _trailer_lp & 0x1; _16bit_word_c <<= 11;
  _16bit_word_c |= _event_info_to_pack -> _trailer_crc22 & 0x7ff;
  _16bit_word_c |= 0xe000;

  _16bit_word_d = _event_info_to_pack -> _trailer_hp & 0x1; _16bit_word_d <<= 11;
  _16bit_word_d |= ( (_event_info_to_pack -> _trailer_crc22) >> 11 ) & 0x7ff;
